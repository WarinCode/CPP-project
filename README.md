...
### เครื่องมือที่ต้องติดตั้งก่อนใช้งาน
...
<code>string path = R"(C:\Users\ACER USER5949486\Desktop\CPP-project\txts\data.txt)"</code> โดยเปลี่ยนเป็น <code>string path = R"(C:\Users\user\Desktop\CPP-project\txts\data.txt)"</code>
